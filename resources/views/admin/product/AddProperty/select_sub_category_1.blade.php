    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <form class="form-horizontal form-label-left" action="{{route('product.addProperty.selectSubCategory2',['main_id'=>$main_id])}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
