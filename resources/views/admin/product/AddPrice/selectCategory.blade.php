@extends('admin.main')
@section('content')
    <form class="form-horizontal form-label-left" action="{{route('product.price.create')}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        ...
        <div id="product_div" style="display: none" class="form-group">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <select name="product_id" id="product_id" class="form-control" selected>
                </select>
            </div>
        </div>

        <div id="div_price" class="col-sm-12" style="display: none" >
            <h2>Fiyatı Gir</h2>
