        ...
        <div class="row">
            <div class="col-lg-3 order-2 order-lg-1">
                <div class="filter-widget">
                    <h2 class="fw-title">Filtereleme</h2>
                    <ul class="category-menu">
                        <form  data-toggle="validator" data-disable="false" role="form" method="post" action="{{route('productController.getFilterProduct',['main_category_id'=>$main_category_id,
                        'sub_category_1_id'=>$sub_category_1_id,'sub_category_2_id'=>$sub_category_2_id])}}">
                        {{csrf_field()}}
                            @foreach($mainProperties as $ozellik)
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <div class="pi-links">
                                    <a href="{{route('name.front.productDetail.index',['id'=>$products[$i]->id,'price'=>$productPrice[$i],'main_category_id'=>$main_category_id,
                                'sub_category_1_id'=>$sub_category_1_id,'sub_category_2_id'=>$sub_category_2_id])}}" class="add-card"><i class="flaticon-bag"></i><span>Ürünü İncele</span></a>
                                    <a  onclick="addFavoriteClick(this.id)" id="{{$products[$i]->id}}" class="wishlist-btn"><i class="flaticon-heart"></i></a>
                                </div>
                            </div>
                            <div class="pi-text">
                                <h6>{{$productPrice[$i]}} {{'₺'}}</h6>
                                <p><a href="{{route('name.front.productDetail.index',['id'=>$products[$i]->id,'price'=>$productPrice[$i],'main_category_id'=>$main_category_id,
                                'sub_category_1_id'=>$sub_category_1_id,'sub_category_2_id'=>$sub_category_2_id])}}">{{$products[$i]->title}}</a></p>
